...
XPT2046_Touchscreen spitouch(TOUCH_CS_PIN);
...
void updateData() {
  ...
  OWMCclient.updateCurrentById(&OWMCdata, OPENWEATHERMAP_APP_ID, OPEN_WEATHER_MAP_LOCATION_ID);

  OWMFclient.setMetric(IS_METRIC);
  OWMFclient.setLanguage(OPENWEATHERMAP_LANGUAGE);
  OWMFclient.setAllowedHours(allowedHours, sizeof(allowedHours));
  uint8_t foundForecasts = OWMFclient.updateForecastsById(OWMFdata, OPENWEATHERMAP_APP_ID, OPEN_WEATHER_MAP_LOCATION_ID, MAX_FORECASTS);
...
String OWM_to_WU_Icon_Mapping(String icon){
  String ic2 = icon.substring(0,2);
  String ic3 = icon.substring(0,3);
  if ((ic2 == "01")||(ic3 == "800")) return "sunny";
  if ((ic2 == "02")||(ic3 == "801")) return "partlycloudy";
  if ((ic2 == "03")||(ic3 == "802")) return "cloudy";
  if ((ic2 == "04")||(ic3 == "803")||(ic3 == "804")) return "mostlycloudy";
  if ((ic2 == "09")||(ic2 == "30")||(ic2 == "31")||(ic2 == "32")) return "chancerain";
  if ((ic2 == "10")||(ic2 == "50")||(ic2 == "51")||(ic2 == "52")||(ic2 == "53")) return "rain";
  if ((ic2 == "11")||(ic2 == "20")||(ic2 == "21")||(ic2 == "23")) return "tstorms";  
  if ((ic2 == "13")||(ic2 == "60")||(ic2 == "61")||(ic2 == "62")) return "snow";
  if ((ic2 == "50")||(ic2 == "70")||(ic2 == "71")||(ic2 == "72")||(ic2 == "73")||(ic2 == "74")||(ic2 == "75")||(ic2 == "76")||(ic2 == "77")||(ic2 == "78")) return "hazy";  
  return "unknown";
}
